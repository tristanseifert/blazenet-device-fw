...
extern void do_log(const unsigned int inLevel, const char *fmt, ...);
...
//#define SPIFFS_GC_DBG(_f, ...) do_log(2, _f, ## __VA_ARGS__)
#endif
// Set spiffs debug output call for caching.
#ifndef SPIFFS_CACHE_DBG
#define SPIFFS_CACHE_DBG(_f, ...)
//#define SPIFFS_CACHE_DBG(_f, ...) do_log(2, _f, ## __VA_ARGS__)
#endif
...
//#define SPIFFS_API_DBG(_f, ...) do_log(2, _f, ## __VA_ARGS__)
#endif
...
// TODO: define these (using a FreeRTOS mutex?)
...
#define spiffs_printf(...)                do_log(3, __VA_ARGS__)
#endif
